 ...
 * @author Almi-
 */
public class SecretariaForm11 extends javax.swing.JFrame {

    /**
     * Creates new form SecretariaForm
     */
    public SecretariaForm11() throws SQLException {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SecretariaForm11.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new SecretariaForm11().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(SecretariaForm11.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
